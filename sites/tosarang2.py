...
URLS = {
	"base": "http://www.tosarang2.net/bbs/",
...
CATEGORIES = ["torrent_kortv_ent", "torrent_kortv_drama"]
HOSTNAME = "tosarang2.net"
...
def do_filter(html):
	return html.find_all("td", class_="td_subject")
